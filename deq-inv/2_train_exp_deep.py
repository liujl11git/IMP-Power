# Train deeper explicit models (not weight-tied like implicit models)
...
parser.add_argument('--maxiters', type=int, default=4)
...
parser.add_argument('--save_name', type=str, default='exp_PGD_iter_4_init_y')
