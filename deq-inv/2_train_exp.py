# Train a pure URNet (explicit model) (set PGD, iters = 1, step size freezed as 0)
...
parser.add_argument('--maxiters', type=int, default=1)
...
parser.add_argument('--save_name', type=str, default='unet_PGD_iter_1_init_y')
